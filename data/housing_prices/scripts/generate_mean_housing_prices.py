...
if __name__ == "__main__":
    ...
    for eircode_output, _df in raw_df.groupby('Eircode Output'):
        ...
        final = preprocessed[['Routing Key', 'City', 'Month', 'Year', 'Dwelling Status', 'Type of Buyer', 'VALUE']].astype({'VALUE': 'float', 'Year': 'int'})
        final.to_csv(f"./data/housing_prices/preprocessed/mean-housing-prices_{routing_key}.csv", index=False)